...
$sql = "SELECT email FROM resets WHERE code = ? AND role = 2 ORDER BY timestamp DESC LIMIT 1";
...
if(isset($_POST['password'])){
  ...
  $sql = "SELECT * FROM bac_users WHERE email = ?"; 
  ...
  if($stmt->execute()){
    ...
    if($stmt->num_rows > 0){
      ...
      $sql = "UPDATE bac_users SET password = ? WHERE email = ?"; 
