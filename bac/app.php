...
<head>
    ...
    <link rel="stylesheet" href="../bac/src/css/dashboard.css">
    ...
    <div class="d-flex">
        ...
        <div class="content flex-grow-1" style="margin-left: 250px; padding: 20px;">
            ...
            <div class="table-container">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        <a href="../bac/src/process/download_excel_app.php" class="btn btn-outline-primary btn-sm" title="Download Table" style="margin-right: 5px;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-justify">
                                        <div class="btn-group" role="group" aria-label="Actions">
                                            <a href="../bac/edit_app.php?ppmp_id=<?php echo $row['ppmp_id']; ?>" class="btn btn-outline-warning btn-sm" title="Update PPMP" style="margin-right: 5px;">
        ...
        <script>
            ...
            function deletePPMP(ppmpId) {
                fetch('../bac/src/process/delete_ppmp.php?ppmp_id=' + ppmpId) // NOTE NOTE NOTE
