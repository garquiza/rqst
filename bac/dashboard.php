    ...
    <div class="d-flex">
        ...
        <div class="content flex-grow-1 animate__animated animate__fadeIn">
            <div class="header-card">
                <h1 class="mb-4">Welcome, <?php echo htmlspecialchars($userFirstName); ?>!</h1>
                <p class="mb-0">Your Email: <?php echo htmlspecialchars($email); ?></p>
                <p class="mb-0">Access Permissions: <?php echo htmlspecialchars($permissions); ?></p>
            </div>
