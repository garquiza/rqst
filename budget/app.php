...
<head>
    ...
    <link rel="stylesheet" href="../budget/src/css/pr.css">
...
<body>
    <div class="d-flex">
        <?php include '../budget/sidebar.php'; ?>
        ...
        <div class="content flex-grow-1" style="margin-left: 250px; padding: 20px;">
            ...
            <div class="table-container">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        <a href="../budget/src/process/download_excel_app.php" class="btn btn-outline-primary btn-sm" title="Download Table" style="margin-right: 5px;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-justify">
                                        <div class="btn-group" role="group" aria-label="Actions">
                                            <a href="../budget/edit_app.php?ppmp_id=<?php echo $row['ppmp_id']; ?>" class="btn btn-outline-warning btn-sm" title="Update PPMP" style="margin-right: 5px;">
