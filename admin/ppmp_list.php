...
// Fetch PPMP data from the database for the current year
$query = "SELECT ppmp_id, project_title, approver, date_created, status FROM ppmp_list WHERE YEAR(date_created) = $currentYear";
                        ...
                        <tr data-status="<?php echo $row['status']; ?>">
                            ...
                            <td class="text-justify">
                                <div class="btn-group" role="group" aria-label="Actions">
                                    ...
                                    <?php if (date("Y", strtotime($row['date_created'])) == $previousYear): ?>
