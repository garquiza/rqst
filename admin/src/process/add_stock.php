    ...
    if (!empty($items)) {
        ...
        try {
            ...
            foreach ($items as $item) {
                $stmt->bind_param("isdsdd", $purchase_order_id, $item['unit'], $item['quantity'], $item['description'], $item['unit_cost'], $item['amount']);
                $stmt->execute();
            }
            ...
            echo json_encode(['status' => 'success', 'purchase_order_id' => $purchase_order_id]);
        } catch (Exception $e) {
