...
// Fetch BAC users from the database
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(`src/process/delete_bac.php`, {
                            method: 'POST', // Change to 'POST' if DELETE is unsupported
                            headers: {
                                'Content-Type': 'application/json'
                            },
                            body: JSON.stringify({
                                id: userId
                            }) // Send id as JSON payload
                        })
                        .then(response => response.json())
                        .then(data => {
                            if (data.success) { // Expect a success flag in the response
                                Swal.fire(
                                    'Deleted!',
