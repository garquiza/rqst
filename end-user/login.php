        ...
        <div class="form-section">
            ...
            <form id="signInForm">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="../end-user/forgot.php">Forgot Password?</a>
                </div>
            ...
            <div class="row mt-4">
                <div class="col text-center">
                    <a href="../admin/login.php" class="btn btn-outline-dark w-100">Admin User</a>
                </div>
                <div class="col text-center">
                ...
                <div class="col text-center">
                    <a href="../end-user/login.php" class="btn btn-outline-dark w-100 active">End User</a>
                </div>
            </div>
        </div>
