...
$sql = "SELECT email FROM resets WHERE code = ? AND role = 4 ORDER BY timestamp DESC LIMIT 1"; 
...
if(isset($_POST['password'])){
  ...
  $sql = "SELECT * FROM end_users WHERE email = ?"; 
  ...
  if($stmt->execute()){
    ...
    if($stmt->num_rows > 0){
      ...
      $sql = "UPDATE end_users SET password = ? WHERE email = ?";  
